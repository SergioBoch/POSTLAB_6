...
; -------------- MACROS ---------------
  ...
  RESET_TMR0 MACRO TMR_VAR
    ...
    BCF ((INTCON) and 07Fh), 2 ; limpiamos flag de interrupción
    ENDM
...
SETUP_TMR1:
    ...
    BCF ((T1CON) and 07Fh), 6 ; TMR1 Siempre cuenta
    BSF ((T1CON) and 07Fh), 5 ; prescaler a TMR1
    BSF ((T1CON) and 07Fh), 4
    BCF ((T1CON) and 07Fh), 3 ; OSC tmr1 desactivado
...
SETUP_INTERRUPCION:
    ...
    BSF ((PIE1) and 07Fh), 0
    BANKSEL INTCON
    BSF ((INTCON) and 07Fh), 6 ; Habilitamos interrupciones
    BSF ((INTCON) and 07Fh), 7 ; Habilitamos interrupcion TMR0
    BSF ((INTCON) and 07Fh), 5 ; Habilitamos interrupcion TMR0
    BCF ((INTCON) and 07Fh), 2 ; Limpiamos flag de TMR0
    BCF ((PIR1) and 07Fh), 0
    RETURN
